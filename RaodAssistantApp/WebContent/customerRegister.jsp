...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <body style="background-color: whitesmoke;">
        <div" class=" navigation bg-dark">
            <div class=" m-1 p-1" style="background: transparent;">
                ...
                <div class="col-12 ">
                    <div style="padding-top: 50%;" class=" mt-5 center  justify-content-center mdc-card p-4 align-middle shadow" style="width: 300px">
                        <div class="card-body ">
                            ...
                            <hr>
                            <form class="align-middle" name="register" action="CustomerServlet" method = "post">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-md-6">
                                                <input type="text" class="form-control" name="customerId" aria-describedby="customerIdHelp"  data-toggle="popover" placeholder=" John Dae..." title="Name" data-content="Name doesn't contain any special characters">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-md-6">
                                                <input type="text" class="form-control" name="customerName" aria-describedby="customerUsernamehelp"  data-toggle="popover" placeholder=" John Dae..." title="UserName" data-content="Name doesn't contain any special characters">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                                <div class="form-group">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-md-6">
                                                <input type="email" class="form-control" name="customerEmailId"  placeholder="abc@mail_id.com " data-toggle="popover" title="emailHelp" data-content="Your Email iD">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-md-6">
                                                <div class="mdc-form-field">
                                                    <div class="mdc-radio">
                                                        <input class="mdc-radio__native-control" type="radio" name="gender" value="Male" >
                                                    ...
                                                    <div class="mdc-radio">
                                                        <input class="mdc-radio__native-control" type="radio" name="gender" value="Female">
                                                        <div class="mdc-radio__background">
                                                            <div class="mdc-radio__outer-circle"></div>
                                                            <div class="mdc-radio__inner-circle"></div>
                                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-md-6">
                                                <input type="date" name="dateOfBirth" class="form-control" id="InputDate" placeholder="yyyy-mm-dd">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-md-6">
                                                <input type="tel" class="form-control" name="contact" id="customerContactNo" aria-describedby="phoneNumberHelp" placeholder="+XX-XXXXXXXXXX" data-toggle="popover" title="Contact Help" data-content="Name doesn't contain any special characters">
                                            </div>
                                        </div>
                                    </div>
                                </div>
